! *** GWSWEX - Groundwater and Surface Water Exchange Model ***
! *** Version 0.1.0 ***
!> @brief GWSWEX - Groundwater and Surface Water Exchange Model
!> @file GWSWEX.f90
...
! # ADD: include a helper subroutine here to pass a variable as pointer to GWSWEX wrapper
